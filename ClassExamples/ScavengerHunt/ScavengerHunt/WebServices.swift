                ...
                case let .success(success):
                    ...
                    if( jsonResponse.response!.statusCode / 100 == 2){
                        ...
                        for(_, jsonObject) in geoCacheArray.enumerated(){
                            ...
                            GeocacheController.createGeoCache(newName: nameString, newDescription: descriptionString, newCategory: "", newLatitude: locationObject["latitiude"] as! Double, newLongitude: locationObject["longitude"] as! Double)
